...
class EdgeGestureController(
    ...
    private fun observeConfig() {
        val observedKeys = setOf(
            ...
            FloatingBallConfig.KEY_EDGE_LEFT_UP_ACTION,
            FloatingBallConfig.KEY_EDGE_LEFT_DOWN_ACTION,
            FloatingBallConfig.KEY_EDGE_LEFT_RIGHT_ACTION,
            FloatingBallConfig.KEY_EDGE_RIGHT_UP_ACTION,
            FloatingBallConfig.KEY_EDGE_RIGHT_DOWN_ACTION,
            FloatingBallConfig.KEY_EDGE_RIGHT_LEFT_ACTION,
